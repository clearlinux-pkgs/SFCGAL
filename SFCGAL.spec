...
Source0  : https://gitlab.com/Oslandia/SFCGAL/-/archive/v1.5.1/SFCGAL-v1.5.1.tar.gz
...
%prep
%setup -q -n SFCGAL-v1.5.1
cd %{_builddir}/SFCGAL-v1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703262210
mkdir -p clr-build
pushd clr-build
