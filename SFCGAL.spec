...
Version  : 1.3.8
Release  : 8
URL      : https://github.com/Oslandia/SFCGAL/archive/v1.3.8/SFCGAL-1.3.8.tar.gz
Source0  : https://github.com/Oslandia/SFCGAL/archive/v1.3.8/SFCGAL-1.3.8.tar.gz
...
%prep
%setup -q -n SFCGAL-1.3.8
cd %{_builddir}/SFCGAL-1.3.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605632602
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/SFCGAL-1.3.8/LICENSE %{buildroot}/usr/share/package-licenses/SFCGAL/4c196d30bdc5653bf02111f19a8412f602932467
pushd clr-build
%make_install
popd
