...
Version  : 1.5.2
Release  : 17
URL      : https://gitlab.com/Oslandia/SFCGAL/-/archive/v1.5.2/SFCGAL-v1.5.2.tar.gz
Source0  : https://gitlab.com/Oslandia/SFCGAL/-/archive/v1.5.2/SFCGAL-v1.5.2.tar.gz
...
%prep
%setup -q -n SFCGAL-v1.5.2
cd %{_builddir}/SFCGAL-v1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721928397
mkdir -p clr-build
pushd clr-build
