...
Source0  : https://gitlab.com/Oslandia/SFCGAL/-/archive/v1.4.1/SFCGAL-v1.4.1.tar.gz
...
%prep
%setup -q -n SFCGAL-v1.4.1
cd %{_builddir}/SFCGAL-v1.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692055583
mkdir -p clr-build
pushd clr-build
