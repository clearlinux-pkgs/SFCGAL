...
Source0  : https://gitlab.com/Oslandia/SFCGAL/-/archive/v1.5.0/SFCGAL-v1.5.0.tar.gz
...
%prep
%setup -q -n SFCGAL-v1.5.0
cd %{_builddir}/SFCGAL-v1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700498059
mkdir -p clr-build
pushd clr-build
