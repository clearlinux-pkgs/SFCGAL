...
Version  : 2.0.0
Release  : 18
URL      : https://gitlab.com/Oslandia/SFCGAL/-/archive/v2.0.0/SFCGAL-v2.0.0.tar.gz
Source0  : https://gitlab.com/Oslandia/SFCGAL/-/archive/v2.0.0/SFCGAL-v2.0.0.tar.gz
...
%prep
%setup -q -n SFCGAL-v2.0.0
cd %{_builddir}/SFCGAL-v2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740428169
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/SFCGAL-v%{version}/LICENSE %{buildroot}/usr/share/package-licenses/SFCGAL/4c196d30bdc5653bf02111f19a8412f602932467 || :
export GOAMD64=v2
GOAMD64=v2
pushd clr-build
%make_install
...
/usr/include/SFCGAL/algorithm/buffer3D.h
...
/usr/include/SFCGAL/algorithm/minkowskiSum3D.h
...
/usr/include/SFCGAL/algorithm/rotate.h
/usr/include/SFCGAL/algorithm/scale.h
